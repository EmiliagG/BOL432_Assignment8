...
Recent archaeological studies have uncovered artwork on three more dragons which could provide new insights into the originally proposed phylogeny on Threadless.Using the data available at: https://github.com/ColauttiLab/DragonPhylogeny, artwork of dragons from Egypt (Figure 1), Iraq (Figure 2), and Korea (Figure 3) will be added to generate a new phylogeny with potentially novel insights into the macro-evolution of these ancient creatures.

"C:\Users\emili\Documents\Queen's\Courses\Fifth Year\BIOL 432\Week Eight\BOL432_Assignment8\images\Ouroborous_Egypt.jpg"
...
![**Figure 2.** "Relief of a mushhushshu dragon", Lent by the Vorderasiatisches Museum, Berlin, VA Bab 4757 to the Metropolitan Museum of Art, NY.  https://www.metmuseum.org/art/collection/search/328299](C:/Users/emili/Documents/Queen's/Courses/Fifth Year/BIOL 432/Week Eight/BOL432_Assignment8/images/MesopotamiaDragon.png){width=40%}
![**Figure 3.** "Dragon Jar", at the Metropolitan Museum of Art, NY.  https://www.metmuseum.org/art/collection/search/328299](C:/Users/emili/Documents/Queen's/Courses/Fifth Year/BIOL 432/Week Eight/BOL432_Assignment8/images/Korea Dragon.png){width=40%}
...
## Results: Distance Matrices and the Phylogenetic Tree
...
ggplot(data = forMelt, aes(x=Query, y=Subject, fill=Distance)) +
  ...
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5)) + theme(text=element_text(size =9))
```
...
The results of the dragon phylogeny reveal the three new dragons from Egypt, Iraq, and Korea form a monophyletic clade. These three dragons are also closely related to Japanese and Turkish dragons. This implies a shared common ancestor(likely more similar in characteristics to the Mesopotamian dragon which is older) diverged in characteristics as it established populations moving eastward as gene flow was interrupted, likely by allopatric speciation. 
